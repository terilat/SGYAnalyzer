...
\section*{Анализ затухания волн: L=760, DW=160, R=0.1}
...
\begin{itemize}
    ...
    \item Экспериментальный индекс прихода продольной волны: 6036
    \item Экспериментальное время прихода продольной волны: $t_{wave} = 2.06$ с
    \item Скорость пришедшей продольной волны: $v_p^{exp} = 369.48$ м/с
    \item Длина продольной волны в индексах: 1369
    \item Длина продольной волны в метрах: $\lambda_p = 172.34$ м
\end{itemize}
...
\begin{itemize}
    ...
    \item Экспериментальное расстояние пересечения волн: $x_{intersection} = 653.17$ м
    \item Номер приемника, ближайшего к пересечению: 33
    \item Индекс прихода падающей волны через ресивер пересечения: 5242
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{./pdfs/figures/wave_analysis_example_760_160_0.1_tensor_imshow.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{./pdfs/figures/wave_analysis_example_760_160_0.1_waves_analysis.png}
...
\hline
\endfoot
720.0 & 1.949 & 2.265 & 2.880 & 2.613 & 3.874e-05 & 1.490e-05 & 2.369e-05 & 38.45\% & 61.15\% \\
