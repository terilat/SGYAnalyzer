...
\section*{Анализ затухания волн: L=500, DW=240, R=0.0001}
...
\begin{itemize}
    ...
    \item Временной шаг: $\Delta t = 2.15e-04$ с
    ...
    \item Величина ошибки: $\varepsilon = 1.62e-08$
\end{itemize}
...
\begin{itemize}
    ...
    \item Экспериментальный индекс прихода продольной волны: 6288
    \item Экспериментальное время прихода продольной волны: $t_{wave} = 1.36$ с
    \item Скорость пришедшей продольной волны: $v_p^{exp} = 368.94$ м/с
    \item Длина продольной волны в индексах: 1985
    \item Длина продольной волны в метрах: $\lambda_p = 157.81$ м
\end{itemize}
...
\begin{itemize}
    ...
    \item Экспериментальный индекс пересечения волн: 7979
    \item Экспериментальное расстояние пересечения волн: $x_{intersection} = 429.93$ м
    \item Номер приемника, ближайшего к пересечению: 21
    \item Индекс прихода падающей волны через ресивер пересечения: 5282
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{./pdfs/figures/wave_analysis_example_500_240_0.0001_tensor_imshow.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{./pdfs/figures/wave_analysis_example_500_240_0.0001_waves_analysis.png}
...
\hline
\endfoot
460.0 & 1.247 & 1.563 & 1.840 & 1.720 & 8.668e-05 & 2.258e-05 & 3.822e-05 & 26.06\% & 44.09\% \\
