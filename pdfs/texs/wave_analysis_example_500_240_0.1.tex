...
\section*{Анализ затухания волн: L=500, DW=240, R=0.1}
...
\begin{itemize}
    ...
    \item Величина ошибки: $\varepsilon = 1.91e-08$
\end{itemize}
...
\begin{itemize}
    ...
    \item Экспериментальный индекс прихода продольной волны: 6269
    \item Экспериментальное время прихода продольной волны: $t_{wave} = 1.35$ с
    \item Скорость пришедшей продольной волны: $v_p^{exp} = 370.06$ м/с
    \item Длина продольной волны в индексах: 1949
    \item Длина продольной волны в метрах: $\lambda_p = 155.42$ м
\end{itemize}
...
\begin{itemize}
    ...
    \item Экспериментальный индекс пересечения волн: 7971
    \item Экспериментальное расстояние пересечения волн: $x_{intersection} = 429.48$ м
    \item Номер приемника, ближайшего к пересечению: 21
    \item Индекс прихода падающей волны через ресивер пересечения: 5266
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{./pdfs/figures/wave_analysis_example_500_240_0.1_tensor_imshow.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{./pdfs/figures/wave_analysis_example_500_240_0.1_waves_analysis.png}
...
\hline
\endfoot
460.0 & 1.243 & 1.559 & 1.840 & 1.718 & 7.415e-05 & 2.059e-05 & 3.140e-05 & 27.76\% & 42.34\% \\
