...
\section*{Анализ затухания волн: L=500, DW=100, R=0.0001}
...
\begin{itemize}
    ...
    \item Величина ошибки: $\varepsilon = 2.16e-08$
\end{itemize}
...
\begin{itemize}
    ...
    \item Экспериментальный индекс прихода продольной волны: 4109
    \item Экспериментальное время прихода продольной волны: $t_{wave} = 1.35$ с
    \item Скорость пришедшей продольной волны: $v_p^{exp} = 369.14$ м/с
    \item Длина продольной волны в индексах: 1040
    \item Длина продольной волны в метрах: $\lambda_p = 126.52$ м
\end{itemize}
...
\begin{itemize}
    ...
    \item Экспериментальный индекс пересечения волн: 5216
    \item Экспериментальное расстояние пересечения волн: $x_{intersection} = 429.85$ м
    \item Номер приемника, ближайшего к пересечению: 21
    \item Индекс прихода падающей волны через ресивер пересечения: 3451
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{./pdfs/figures/wave_analysis_example_500_100_0.0001_tensor_imshow.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{./pdfs/figures/wave_analysis_example_500_100_0.0001_waves_analysis.png}
...
\hline
\endfoot
460.0 & 1.246 & 1.563 & 1.840 & 1.719 & 9.832e-05 & 2.736e-05 & 3.662e-05 & 27.83\% & 37.25\% \\
