...
\section*{Анализ затухания волн: L=500, DW=160, R=0.01}
...
\begin{itemize}
    ...
    \item Величина ошибки: $\varepsilon = 1.81e-08$
\end{itemize}
...
\begin{itemize}
    ...
    \item Экспериментальный индекс прихода продольной волны: 4194
    ...
    \item Длина продольной волны в индексах: 1180
    \item Длина продольной волны в метрах: $\lambda_p = 140.64$ м
\end{itemize}
...
\begin{itemize}
    ...
    \item Экспериментальный индекс пересечения волн: 5330
    ...
    \item Индекс прихода падающей волны через ресивер пересечения: 3523
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{./pdfs/figures/wave_analysis_example_500_160_0.01_tensor_imshow.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{./pdfs/figures/wave_analysis_example_500_160_0.01_waves_analysis.png}
...
\hline
\endfoot
460.0 & 1.244 & 1.560 & 1.840 & 1.718 & 8.802e-05 & 2.537e-05 & 3.706e-05 & 28.82\% & 42.10\% \\
