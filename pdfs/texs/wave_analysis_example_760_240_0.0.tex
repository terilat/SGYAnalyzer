...
\section*{Анализ затухания волн: L=760, DW=240, R=0.0}
...
\begin{itemize}
    ...
    \item Экспериментальный индекс прихода продольной волны: 6035
    \item Экспериментальное время прихода продольной волны: $t_{wave} = 2.06$ с
    \item Скорость пришедшей продольной волны: $v_p^{exp} = 369.54$ м/с
    \item Длина продольной волны в индексах: 2129
    \item Длина продольной волны в метрах: $\lambda_p = 268.06$ м
\end{itemize}
...
\begin{itemize}
    ...
    \item Экспериментальный индекс пересечения волн: 7667
    \item Экспериментальное расстояние пересечения волн: $x_{intersection} = 653.13$ м
    \item Номер приемника, ближайшего к пересечению: 33
    \item Индекс прихода падающей волны через ресивер пересечения: 5241
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{./pdfs/figures/wave_analysis_example_760_240_0.0_tensor_imshow.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{./pdfs/figures/wave_analysis_example_760_240_0.0_waves_analysis.png}
...
\hline
\endfoot
720.0 & 1.948 & 2.265 & 2.880 & 2.613 & 7.996e-05 & 1.465e-05 & 1.465e-05 & 18.32\% & 18.32\% \\
