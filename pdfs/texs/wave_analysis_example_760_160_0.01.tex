...
\section*{Анализ затухания волн: L=760, DW=160, R=0.01}
...
\begin{itemize}
    ...
    \item Экспериментальный индекс прихода продольной волны: 6041
    \item Экспериментальное время прихода продольной волны: $t_{wave} = 2.06$ с
    \item Скорость пришедшей продольной волны: $v_p^{exp} = 369.17$ м/с
    \item Длина продольной волны в индексах: 1368
    \item Длина продольной волны в метрах: $\lambda_p = 172.07$ м
\end{itemize}
...
\begin{itemize}
    ...
    \item Экспериментальный индекс пересечения волн: 7669
    \item Экспериментальное расстояние пересечения волн: $x_{intersection} = 653.35$ м
    \item Номер приемника, ближайшего к пересечению: 33
    \item Индекс прихода падающей волны через ресивер пересечения: 5246
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{./pdfs/figures/wave_analysis_example_760_160_0.01_tensor_imshow.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{./pdfs/figures/wave_analysis_example_760_160_0.01_waves_analysis.png}
...
\hline
\endfoot
720.0 & 1.950 & 2.267 & 2.880 & 2.613 & 4.337e-05 & 1.687e-05 & 2.761e-05 & 38.90\% & 63.67\% \\
