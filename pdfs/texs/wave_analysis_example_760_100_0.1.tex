...
\section*{Анализ затухания волн: L=760, DW=100, R=0.1}
...
\begin{itemize}
    ...
    \item Экспериментальный индекс прихода продольной волны: 6034
    \item Экспериментальное время прихода продольной волны: $t_{wave} = 2.06$ с
    \item Скорость пришедшей продольной волны: $v_p^{exp} = 369.60$ м/с
    \item Длина продольной волны в индексах: 1300
    \item Длина продольной волны в метрах: $\lambda_p = 163.71$ м
\end{itemize}
...
\begin{itemize}
    ...
    \item Экспериментальный индекс пересечения волн: 7666
    \item Экспериментальное расстояние пересечения волн: $x_{intersection} = 653.09$ м
    \item Номер приемника, ближайшего к пересечению: 33
    \item Индекс прихода падающей волны через ресивер пересечения: 5240
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{./pdfs/figures/wave_analysis_example_760_100_0.1_tensor_imshow.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{./pdfs/figures/wave_analysis_example_760_100_0.1_waves_analysis.png}
...
\hline
\endfoot
720.0 & 1.948 & 2.264 & 2.880 & 2.612 & 3.789e-05 & 1.336e-05 & 2.252e-05 & 35.27\% & 59.43\% \\
