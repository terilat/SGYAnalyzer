...
\section*{Анализ затухания волн: L=500, DW=160, R=0.0001}
...
\begin{itemize}
    ...
    \item Величина ошибки: $\varepsilon = 1.76e-08$
\end{itemize}
...
\begin{itemize}
    ...
    \item Экспериментальный индекс прихода продольной волны: 4202
    \item Экспериментальное время прихода продольной волны: $t_{wave} = 1.35$ с
    \item Скорость пришедшей продольной волны: $v_p^{exp} = 369.05$ м/с
    \item Длина продольной волны в индексах: 1165
    \item Длина продольной волны в метрах: $\lambda_p = 138.59$ м
\end{itemize}
...
\begin{itemize}
    ...
    \item Экспериментальный индекс пересечения волн: 5333
    \item Экспериментальное расстояние пересечения волн: $x_{intersection} = 429.88$ м
    \item Номер приемника, ближайшего к пересечению: 21
    \item Индекс прихода падающей волны через ресивер пересечения: 3530
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{./pdfs/figures/wave_analysis_example_500_160_0.0001_tensor_imshow.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{./pdfs/figures/wave_analysis_example_500_160_0.0001_waves_analysis.png}
...
\hline
\endfoot
460.0 & 1.246 & 1.563 & 1.840 & 1.720 & 9.745e-05 & 2.844e-05 & 4.080e-05 & 29.19\% & 41.87\% \\
