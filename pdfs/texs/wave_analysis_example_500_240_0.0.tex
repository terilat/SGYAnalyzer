...
\section*{Анализ затухания волн: L=500, DW=240, R=0.0}
...
\begin{itemize}
    ...
    \item Величина ошибки: $\varepsilon = 9.27e-08$
\end{itemize}
...
\begin{itemize}
    ...
    \item Экспериментальный индекс прихода продольной волны: 6281
    \item Экспериментальное время прихода продольной волны: $t_{wave} = 1.35$ с
    \item Скорость пришедшей продольной волны: $v_p^{exp} = 369.35$ м/с
    \item Длина продольной волны в индексах: 2298
    \item Длина продольной волны в метрах: $\lambda_p = 182.90$ м
\end{itemize}
...
\begin{itemize}
    ...
    \item Экспериментальный индекс пересечения волн: 7976
    \item Экспериментальное расстояние пересечения волн: $x_{intersection} = 429.77$ м
    \item Номер приемника, ближайшего к пересечению: 21
    \item Индекс прихода падающей волны через ресивер пересечения: 5276
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{./pdfs/figures/wave_analysis_example_500_240_0.0_tensor_imshow.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{./pdfs/figures/wave_analysis_example_500_240_0.0_waves_analysis.png}
...
\hline
\endfoot
460.0 & 1.245 & 1.562 & 1.840 & 1.719 & 1.171e-04 & 1.767e-05 & 1.916e-05 & 15.09\% & 16.36\% \\
