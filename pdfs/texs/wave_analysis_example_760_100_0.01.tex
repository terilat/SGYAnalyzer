...
\section*{Анализ затухания волн: L=760, DW=100, R=0.01}
...
\begin{itemize}
    ...
    \item Экспериментальный индекс прихода продольной волны: 6038
    ...
    \item Длина продольной волны в индексах: 1296
    \item Длина продольной волны в метрах: $\lambda_p = 163.09$ м
\end{itemize}
...
\begin{itemize}
    ...
    \item Экспериментальный индекс пересечения волн: 7668
    \item Экспериментальное расстояние пересечения волн: $x_{intersection} = 653.24$ м
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{./pdfs/figures/wave_analysis_example_760_100_0.01_tensor_imshow.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{./pdfs/figures/wave_analysis_example_760_100_0.01_waves_analysis.png}
...
\hline
\endfoot
720.0 & 1.949 & 2.266 & 2.880 & 2.613 & 4.251e-05 & 1.498e-05 & 2.576e-05 & 35.24\% & 60.61\% \\
