...
\section*{Анализ затухания волн: L=760, DW=160, R=0.0001}
...
\begin{itemize}
    ...
    \item Величина ошибки: $\varepsilon = 1.02e-07$
\end{itemize}
...
\begin{itemize}
    ...
    \item Экспериментальный индекс прихода продольной волны: 6052
    \item Экспериментальное время прихода продольной волны: $t_{wave} = 2.06$ с
    \item Скорость пришедшей продольной волны: $v_p^{exp} = 368.50$ м/с
    \item Длина продольной волны в индексах: 1351
    \item Длина продольной волны в метрах: $\lambda_p = 169.62$ м
\end{itemize}
...
\begin{itemize}
    ...
    \item Экспериментальный индекс пересечения волн: 7674
    \item Экспериментальное расстояние пересечения волн: $x_{intersection} = 653.76$ м
    \item Номер приемника, ближайшего к пересечению: 33
    \item Индекс прихода падающей волны через ресивер пересечения: 5256
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{./pdfs/figures/wave_analysis_example_760_160_0.0001_tensor_imshow.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{./pdfs/figures/wave_analysis_example_760_160_0.0001_waves_analysis.png}
...
\hline
\endfoot
720.0 & 1.954 & 2.270 & 2.880 & 2.615 & 4.785e-05 & 1.836e-05 & 3.068e-05 & 38.36\% & 64.11\% \\
