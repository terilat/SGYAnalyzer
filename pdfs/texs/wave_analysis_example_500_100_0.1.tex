...
\section*{Анализ затухания волн: L=500, DW=100, R=0.1}
...
\begin{itemize}
    ...
    \item Величина ошибки: $\varepsilon = 2.09e-08$
\end{itemize}
...
\begin{itemize}
    ...
    \item Экспериментальный индекс прихода продольной волны: 4100
    \item Экспериментальное время прихода продольной волны: $t_{wave} = 1.35$ с
    \item Скорость пришедшей продольной волны: $v_p^{exp} = 369.95$ м/с
    \item Длина продольной волны в индексах: 1067
    \item Длина продольной волны в метрах: $\lambda_p = 130.09$ м
\end{itemize}
...
\begin{itemize}
    ...
    \item Экспериментальный индекс пересечения волн: 5212
    ...
    \item Индекс прихода падающей волны через ресивер пересечения: 3444
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{./pdfs/figures/wave_analysis_example_500_100_0.1_tensor_imshow.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{./pdfs/figures/wave_analysis_example_500_100_0.1_waves_analysis.png}
...
\hline
\endfoot
460.0 & 1.243 & 1.560 & 1.840 & 1.718 & 7.738e-05 & 1.973e-05 & 2.792e-05 & 25.50\% & 36.09\% \\
