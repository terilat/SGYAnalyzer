...
\section*{Анализ затухания волн: L=500, DW=160, R=0.0}
...
\begin{itemize}
    ...
    \item Экспериментальный индекс прихода продольной волны: 4199
    ...
    \item Длина продольной волны в индексах: 1519
    \item Длина продольной волны в метрах: $\lambda_p = 180.83$ м
\end{itemize}
...
\begin{itemize}
    ...
    \item Индекс прихода падающей волны через ресивер пересечения: 3527
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{./pdfs/figures/wave_analysis_example_500_160_0.0_tensor_imshow.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{./pdfs/figures/wave_analysis_example_500_160_0.0_waves_analysis.png}
...
\hline
\endfoot
460.0 & 1.246 & 1.562 & 1.840 & 1.719 & 1.171e-04 & 1.766e-05 & 1.921e-05 & 15.08\% & 16.40\% \\
