...
\section*{Анализ затухания волн: L=500, DW=100, R=0.01}
...
\begin{itemize}
    ...
    \item Величина ошибки: $\varepsilon = 2.07e-08$
\end{itemize}
...
\begin{itemize}
    ...
    \item Экспериментальный индекс прихода продольной волны: 4103
    \item Экспериментальное время прихода продольной волны: $t_{wave} = 1.35$ с
    \item Скорость пришедшей продольной волны: $v_p^{exp} = 369.68$ м/с
    \item Длина продольной волны в индексах: 1060
    \item Длина продольной волны в метрах: $\lambda_p = 129.14$ м
\end{itemize}
...
\begin{itemize}
    ...
    \item Экспериментальный индекс пересечения волн: 5214
    \item Экспериментальное расстояние пересечения волн: $x_{intersection} = 429.63$ м
    \item Номер приемника, ближайшего к пересечению: 21
    \item Индекс прихода падающей волны через ресивер пересечения: 3446
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{./pdfs/figures/wave_analysis_example_500_100_0.01_tensor_imshow.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{./pdfs/figures/wave_analysis_example_500_100_0.01_waves_analysis.png}
...
\hline
\endfoot
460.0 & 1.244 & 1.561 & 1.840 & 1.719 & 8.710e-05 & 2.291e-05 & 3.247e-05 & 26.30\% & 37.28\% \\
