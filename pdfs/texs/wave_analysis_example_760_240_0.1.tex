...
\section*{Анализ затухания волн: L=760, DW=240, R=0.1}
...
\begin{itemize}
    ...
    \item Экспериментальный индекс прихода продольной волны: 6037
    \item Экспериментальное время прихода продольной волны: $t_{wave} = 2.06$ с
    \item Скорость пришедшей продольной волны: $v_p^{exp} = 369.42$ м/с
    \item Длина продольной волны в индексах: 1466
    \item Длина продольной волны в метрах: $\lambda_p = 184.52$ м
\end{itemize}
...
\begin{itemize}
    ...
    \item Экспериментальное расстояние пересечения волн: $x_{intersection} = 653.20$ м
    \item Номер приемника, ближайшего к пересечению: 33
    \item Индекс прихода падающей волны через ресивер пересечения: 5243
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{./pdfs/figures/wave_analysis_example_760_240_0.1_tensor_imshow.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{./pdfs/figures/wave_analysis_example_760_240_0.1_waves_analysis.png}
...
\hline
\endfoot
720.0 & 1.949 & 2.265 & 2.880 & 2.613 & 3.688e-05 & 1.504e-05 & 2.393e-05 & 40.77\% & 64.90\% \\
