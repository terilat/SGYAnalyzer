...
\section*{Анализ затухания волн: L=500, DW=240, R=0.001}
...
\begin{itemize}
    ...
    \item Величина ошибки: $\varepsilon = 1.64e-08$
\end{itemize}
...
\begin{itemize}
    ...
    \item Длина продольной волны в индексах: 1981
    \item Длина продольной волны в метрах: $\lambda_p = 157.67$ м
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{./pdfs/figures/wave_analysis_example_500_240_0.001_tensor_imshow.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{./pdfs/figures/wave_analysis_example_500_240_0.001_waves_analysis.png}
...
\hline
\endfoot
460.0 & 1.245 & 1.562 & 1.840 & 1.719 & 8.436e-05 & 2.230e-05 & 3.776e-05 & 26.44\% & 44.77\% \\
