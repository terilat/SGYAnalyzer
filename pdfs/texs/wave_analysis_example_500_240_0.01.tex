...
\section*{Анализ затухания волн: L=500, DW=240, R=0.01}
...
\begin{itemize}
    ...
    \item Величина ошибки: $\varepsilon = 1.69e-08$
\end{itemize}
...
\begin{itemize}
    ...
    \item Экспериментальный индекс прихода продольной волны: 6274
    \item Экспериментальное время прихода продольной волны: $t_{wave} = 1.35$ с
    \item Скорость пришедшей продольной волны: $v_p^{exp} = 369.76$ м/с
    \item Длина продольной волны в индексах: 1974
    \item Длина продольной волны в метрах: $\lambda_p = 157.29$ м
\end{itemize}
...
\begin{itemize}
    ...
    \item Экспериментальный индекс пересечения волн: 7973
    \item Экспериментальное расстояние пересечения волн: $x_{intersection} = 429.60$ м
    \item Номер приемника, ближайшего к пересечению: 21
    \item Индекс прихода падающей волны через ресивер пересечения: 5270
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{./pdfs/figures/wave_analysis_example_500_240_0.01_tensor_imshow.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{./pdfs/figures/wave_analysis_example_500_240_0.01_waves_analysis.png}
...
\hline
\endfoot
460.0 & 1.244 & 1.560 & 1.840 & 1.718 & 8.062e-05 & 2.183e-05 & 3.621e-05 & 27.07\% & 44.91\% \\
