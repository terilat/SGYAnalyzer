...
\section*{Анализ затухания волн: L=760, DW=240, R=0.0001}
...
\begin{itemize}
    ...
    \item Величина ошибки: $\varepsilon = 1.04e-07$
\end{itemize}
...
\begin{itemize}
    ...
    \item Экспериментальный индекс прихода продольной волны: 6058
    \item Экспериментальное время прихода продольной волны: $t_{wave} = 2.06$ с
    \item Скорость пришедшей продольной волны: $v_p^{exp} = 368.14$ м/с
    \item Длина продольной волны в индексах: 1457
    \item Длина продольной волны в метрах: $\lambda_p = 182.75$ м
\end{itemize}

\subsection*{Анализ пересечения волн}

\begin{itemize}
    \item Экспериментальное время пересечения волн: $t_{intersection} = 2.62$ с
    \item Экспериментальный индекс пересечения волн: 7677
    \item Экспериментальное расстояние пересечения волн: $x_{intersection} = 653.98$ м
    \item Номер приемника, ближайшего к пересечению: 33
    \item Индекс прихода падающей волны через ресивер пересечения: 5261
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{./pdfs/figures/wave_analysis_example_760_240_0.0001_tensor_imshow.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{./pdfs/figures/wave_analysis_example_760_240_0.0001_waves_analysis.png}
...
\hline
\endfoot
720.0 & 1.956 & 2.273 & 2.880 & 2.616 & 4.373e-05 & 1.783e-05 & 3.088e-05 & 40.78\% & 70.60\% \\
